        ...
        <main class="container mx-auto px-6 py-8">
            ...
            <div class="glass-card rounded-xl p-6 mb-6 animate-slide-up" style="animation-delay: 0.1s;">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button class="px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:bg-primary/90 transition-all duration-200 hover:shadow-lg hover:scale-105">
                        + Add Member
                    </button>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <div class="mt-4 flex space-x-2">
                            <button class="flex-1 px-3 py-2 bg-primary/10 text-primary rounded-lg text-sm font-medium hover:bg-primary/20 transition-all duration-200">
                                View Profile
                            </button>
                            <button class="px-3 py-2 bg-muted hover:bg-muted/80 rounded-lg transition-all duration-200">
